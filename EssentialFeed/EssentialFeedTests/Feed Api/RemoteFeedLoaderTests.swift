...
class RemoteFeedLoaderTests: XCTestCase {
    ...
    func test_laod_doesNotDeliverResultsAfterSUTInstanceHasBeenDeallocated() {
    ...
    private func expect(_ sut: RemoteFeedLoader,
        ...
        sut.load { receivedResult in
            ...
            default:
                XCTFail("Expected Result \(expectedResult) got \(receivedResult) instedad", file: file, line: line)
            }
